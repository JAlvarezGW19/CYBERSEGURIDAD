...
\section*{6. Desarrollo en Paralelo}
No es necesario esperar a que otros grupos terminen sus módulos. Usted puede probar su funcionalidad utilizando objetivos directos (IPs o dominios conocidos). La integración final se basa en el cumplimiento del esquema JSON, no en la interdependencia del código.
